define(['zuiRoot/common',
    ...
    return {
        fabricateTrigger: function( settings ){
        ...
        fabricateTimedRule: function(settings) {
            settings = typeof settings === 'undefined' ? {} : settings;
            
            //check required params to continue

            var rule = {
                //owner:
                target: settings.target,
                evaluate: settings.evaluate, // eval(event and trigger info?)
